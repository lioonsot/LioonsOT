...
--	},
	{
		...
		rookgaard = false,
		offers = {
			{name = "Todos os Blessings Basicos", thingId = 1, 2, 3, 4, 5, 7, 8, type = GameStore.OfferTypes.OFFER_TYPE_BLESSINGS, price = 40, icons = {"BlessingAllPvE.png"}},
			{name = "Twist of Fate", thingId = 1, type = GameStore.OfferTypes.OFFER_TYPE_BLESSINGS, price = 2, icons = {"BlessingFate.png"}},
			{name = "The Wisdom of Solitude", thingId = 2, type = GameStore.OfferTypes.OFFER_TYPE_BLESSINGS, price = 5, icons = {"BlessingSolitude.png"}},
			{name = "The Spark of the Phoenix", thingId = 3, type = GameStore.OfferTypes.OFFER_TYPE_BLESSINGS, price = 8, icons = {"BlessingPhoenix.png"}},
			{name = "The Fire of the Suns", thingId = 4, type = GameStore.OfferTypes.OFFER_TYPE_BLESSINGS, price = 5, icons = {"BlessingSuns.png"}},
			{name = "The Spiritual Shielding", thingId = 5, type = GameStore.OfferTypes.OFFER_TYPE_BLESSINGS, price = 5, icons = {"BlessingShielding.png"}},
			{name = "The Embrace of Tibia", thingId = 6, type = GameStore.OfferTypes.OFFER_TYPE_BLESSINGS, price = 5, icons = {"BlessingTibia.png"}},
			{name = "Heart of the Mountain", thingId = 7, type = GameStore.OfferTypes.OFFER_TYPE_BLESSINGS, price = 10, icons = {"BlessingHeart.png"}},
			{name = "Blood of the Mountain", thingId = 8, type = GameStore.OfferTypes.OFFER_TYPE_BLESSINGS, price = 10, icons = {"BlessingBlood.png"}},
		}
	},
	{
		name = "Extras",
		state = GameStore.States.STATE_NONE,
		rookgaard = false,
		icons = {"ExtraServices.png"},
		offers = {
			-- NameChange example
			{name = "Mudança de Nome", type = GameStore.OfferTypes.OFFER_TYPE_NAMECHANGE, price = 20, icons = {"Product_CharacterNameChange.png"}},
			-- Sexchange example
			{name = "Mudança de Sexo", type = GameStore.OfferTypes.OFFER_TYPE_SEXCHANGE, price = 20, icons = {"Product_CharacterSexChange.png"}},
	...
	},
	{
		...
		offers = {
			{name = "Prey Reroll Bonus", state = GameStore.States.STATE_NEW, count = 1, type = GameStore.OfferTypes.OFFER_TYPE_PREYBONUS, price = 1, icons = {"PreyReroll.png"}},
			{name = "5x Prey Reroll Bonus", state = GameStore.States.STATE_NEW, count = 5, type = GameStore.OfferTypes.OFFER_TYPE_PREYBONUS, price = 4, icons = {"PreyReroll.png"}},
			{name = "Prey Slot Permanente", state = GameStore.States.STATE_NEW, type = GameStore.OfferTypes.OFFER_TYPE_PREYSLOT, price = 50, icons = {"PreySlot.png"}},
			{name = "Gold Pounch", thingId = 26377, count = 1, type = GameStore.OfferTypes.OFFER_TYPE_ITEM, price = 5, icons = {"GoldPouch.png"}, description = ""},
		}
	},
	{
		name = "Bonus",
		...
		icons = {"Boosts.png"},
		offers = {
			{name = "50% XP Bonus", state = GameStore.States.STATE_NEW, type = GameStore.OfferTypes.OFFER_TYPE_EXPBOOST, price = 99, icons = {"Xp_Boost.png"}, description="50% XP Boost por 1 hora!"},
		}
	},
	{
		name = "Runas",
	...
	},
	{
		...
		offers = {
			...
			{name = "Full Entrepreneur Outfits", thingId = {male=472,female=471}, addon = 3, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 65, icons = {"EntrepreneurMaleFull.png","EntrepreneurFemaleFull.png"}},
			{name = "Entrepreneur Outfits", thingId = {male=472,female=471}, addon = 0, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 15, icons = {"EntrepreneurMaleBase.png","EntrepreneurFemaleBase.png"}},
			{name = "Entrepreneur Outfits Addon 1", thingId = {male=472,female=471}, addon = 1, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 30, icons = {"EntrepreneurMaleAddon1.png","EntrepreneurFemaleAddon1.png"}},
			{name = "Entrepreneur Outfits Addon 2", thingId = {male=472,female=471}, addon = 2, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT_ADDON, price = 30, icons = {"EntrepreneurMaleAddon2.png","EntrepreneurFemaleAddon2.png"}}
		}
	},
	{
		name = "Retro Outfits",
		...
		rookgaard = false,
		offers = {
			{name = "Retro Citizen Outfit", thingId = {male=974,female=975}, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 60, icons = {"f974.png","f975.png"}},
			{name = "Retro Hunter Outfit", thingId = {male=972,female=973}, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 60, icons = {"f972.png","f973.png"}},
			{name = "Retro Knight Outfit", thingId = {male=970,female=971}, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 60, icons = {"f970.png","f971.png"}},
			{name = "Retro Mage Outfit", thingId = {male=968,female=969}, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 60, icons = {"f968.png","f969.png"}},
			{name = "Retro Warrior Outfit", thingId = {male=962,female=963}, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 60, icons = {"f962.png","f963.png"}},
			{name = "Retro Summoner Outfit", thingId = {male=964,female=965}, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 60, icons = {"f964.png","f965.png"}},
			{name = "Retro Nobleman Outfit", thingId = {male=966,female=967}, type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT, price = 60, icons = {"f966.png","f967.png"}}
		}
	},
	{
		name = "Montarias",
		...
		offers = {
			...
			{name = "Magic Carpet", thingId = 66, type = GameStore.OfferTypes.OFFER_TYPE_MOUNT, price = 60, icons = {"MagicCarpet.png"}, description = "Here you can purchase the Mount  for your character. Riding on a mount is not only cool, but also gives your character a speed boost."}
		}
	},
	{
		...
		rookgaard = false,
		offers = {
			{name = "Gilded Imbuing Shrine", description = "Buy an incredible Gilded Imbuing Shrine to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27838, count = 1, price = 200, icons = {"GildedImbuingShrine.png"}},
			{name = "Imbuing Shrine", description = "Buy an incredible Imbuing Shrine to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27830, count = 1, price = 150, icons = {"ImbuingShrine.png"}},
			{name = "Magnificent Cabinet", description = "Buy an incredible Magnificent Cabinet to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 26075, count = 1, price = 100, icons = {"MagnificantCabinet.png"}},
			...
			{name = "vengothic cabinet", description = "Buy an incredible Vengothic Cabinet to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27901, count = 1, price = 100, icons = {"VengothicCabinet.png"}},
			{name = "Vengothic Chair", description = "Buy an incredible Vengothic Chair to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27895, count = 1, price = 50, icons = {"VengothicChair.png"}},
			{name = "Vengothic Chest", description = "Buy an incredible Vengothic Chest to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27903, count = 1, price = 80, icons = {"VengothicChest.png"}},
			{name = "Vengothic Table", description = "Buy an incredible Vengothic Table to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27899, count = 1, price = 50, icons = {"VengothicTable.png"}},
			{name = "Bitter-Smack Leaf", description = "Buy an incredible Bitter-Smack Leaf to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27891, count = 1, price = 50, icons = {"Bitter-SmackLeaf.png"}},
			{name = "Blooming Cactus", description = "Buy an incredible Blooming Cactus to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27890, count = 1, price = 50, icons = {"BloomingCactus.png"}},
			{name = "Pink Roses", description = "Buy an incredible Pink Roses to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27892, count = 1, price = 50, icons = {"PinkRoses.png"}},
			{name = "Red Roses", description = "Buy an incredible Red Roses to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27893, count = 1, price = 50, icons = {"RedRoses.png"}},
			{name = "Yellow Roses", description = "Buy an incredible Yellow Roses to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27894, count = 1, price = 50, icons = {"YellowRoses.png"}},
			...
			{name = "Flowery Carpet", description = "Buy an incredible Flowery Carpet to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27072, count = 1, price = 35, icons = {"FloweryCarpet.png"}},
			{name = "Colourful Carpet", description = "Buy an incredible Colourful Carpet to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27081, count = 1, price = 35, icons = {"ColourfulCarpet.png"}},
			{name = "Striped Carpet", description = "Buy an incredible Striped Carpet to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27074, count = 1, price = 35, icons = {"StripedCarpet.png"}},
			{name = "Fur Carpet", description = "Buy an incredible Fur Carpet to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27075, count = 1, price = 30, icons = {"FurCarpet.png"}},
			{name = "Diamond Carpet", description = "Buy an incredible Diamond Carpet to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27076, count = 1, price = 30, icons = {"DiamondCarpet.png"}},
			{name = "Patterned Carpet", description = "Buy an incredible Patterned Carpet to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27077, count = 1, price = 30, icons = {"PatternedCarpet.png"}},
			{name = "Night Sky Carpet", description = "Buy an Night Sky Carpet Carpet to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27078, count = 1, price = 30, icons = {"NightSkyCarpet.png"}},
			{name = "Star Carpet", description = "Buy an incredible Star Carpet to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27079, count = 1, price = 30, icons = {"StarCarpet.png"}},
			...
			{name = "Fish Tank", description = "Buy an incredible Fish Tank to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 26347, count = 1, price = 180, icons = {"FishTank.png"}},
			{name = "Dog House", description = "Buy an incredible Dog House to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 26353, count = 1, price = 150, icons = {"DogHouse.png"}},
			{name = "Baby Dragon", description = "Buy an incredible Baby Dragon to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 26098, count = 1, price = 250, icons = {"BabyDragon.png"}},
			{name = "Cat in a Basket", description = "Buy an incredible Cat in a Basket to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 26107, count = 1, price = 150, icons = {"Cat.png"}},
			...
			{name = "Parrot", description = "Buy an incredible Parrot to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27088, count = 1, price = 180, icons = {"Parrot.png"}},
			{name = "Chamaleon", description = "Buy an incredible Chamaleon to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27887, count = 1, price = 250, icons = {"Chamaleon.png"}},
			{name = "Birdcage", description = "Buy an incredible Birdcage to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 2094, count = 1, price = 250, icons = {"Birdcage.png"}},
			...
			{name = "Skull Lamp", description = "Buy an incredible Skull Lamp to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27090, count = 1, price = 90, icons = {"SkullLamp.png"}},
			{name = "Vengothic Lamp", description = "Buy an incredible Vengothic Lamp to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 27884, count = 1, price = 180, icons = {"VengothicLamp.png"}},
			{name = "Ornate Mailbox", description = "Buy an incredible Ornate Mailbox to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 26057, count = 1, price = 200, icons = {"ornatemailbox.png"}},
			{name = "Royal Mailbox", description = "Buy an incredible Royal Mailbox to decorate your home.", type = GameStore.OfferTypes.OFFER_TYPE_HOUSE, thingId = 26055, count = 1, price = 150, icons = {"royalmailbox.png"}},
