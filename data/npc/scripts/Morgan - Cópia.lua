...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'forge') then
		npcHandler:say('What would you like me to forge for you? A {knights sword} or a {warrior\'s sword}?', cid)
...
keywordHandler:addKeyword({'weapons'}, StdModule.say, {npcHandler = npcHandler, text = 'Would you rather be interested in a {knights sword} or in a {warrior\'s sword}?'})
